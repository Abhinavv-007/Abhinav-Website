...
export const startChat = (languageName: string, history: ChatMessage[]): Chat => {
...
export const generateSummary = async (textToSummarize: string, languageName: string): Promise<string> => {
...
export const generateSuggestions = async (history: ChatMessage[], languageName: string): Promise<string[]> => {
